...
const socioeconomicoSchema = new mongoose.Schema(
  {
    ...
    tipo_apoyo: {
      type: String,
      enum: ["Beca", "Auxilio económico", "Subsidio transporte", "Material académico", "Otro"],
      default: "Auxilio económico",
    },
    fecha_solicitud: {
      type: Date,
      default: Date.now,
...
module.exports = mongoose.model("Socioeconomico", socioeconomicoSchema)
