...
const talleresSchema = new mongoose.Schema(
  {
    ...
    nombre_taller: { type: String, required: true, maxlength: 100 },
    fecha_taller: { type: Date, required: true },
    observaciones: { type: String, maxlength: 255 },
    facilitador: { type: String, maxlength: 100 },
    duracion_horas: { type: Number, min: 1, default: 2 },
    asistencia: { type: Boolean, default: true },
    calificacion: { type: Number, min: 1, max: 5 },
    estado: { type: String, enum: ['Programado', 'En curso', 'Completado', 'Cancelado'], default: 'Programado' },
...
export default mongoose.model('Talleres', talleresSchema)
